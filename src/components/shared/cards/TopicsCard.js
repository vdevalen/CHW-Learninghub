...
const TopicsCard = ({ title, subtitle, text, img }) => {
  return (
    <div className="col-sm-4 mb-4"> {/* Added 'mb-4' for margin-bottom */}
      <div className="card" style={{ width: "320px", height: "465px", marginRight: "20px" }}>
        <img className="card-img-top" src={img} style={{ height: "150px" }} alt="Card image cap" />
